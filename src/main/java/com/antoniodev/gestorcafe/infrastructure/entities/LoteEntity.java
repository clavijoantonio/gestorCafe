...
public class LoteEntity {
    ...
    public LoteEntity(long id, String codigo, long farmId, String nombre, String area, String cultivoId, LocalDate fechaSiembra, LocalDate fechaCosecha, float densidaSiembra, float altitud, String tipoSuelo, String estado, String obsevaciones) {
        this.id = id;
        this.codigo = codigo;
        this.farmId = farmId;
        this.nombre = nombre;
