...
public class Farm {
    ...
    public Farm(long id, String nombre, long propietario_id, long ubicacion_id, float area_total, boolean cerficacion_organica, Date fecha_aquisicion, String obsevaciones, boolean activa) {
        this.id = id;
        this.nombre = nombre;
